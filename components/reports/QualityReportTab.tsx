      ...
      <Card variant="bordered">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-lg font-bold text-gray-900 flex items-center gap-2">
            ...
            Quality Objectives Reports
          </h3>
          <span className="text-xs font-medium text-gray-500 bg-gray-100 px-3 py-1 rounded-full">
            {qualityAddedMonths.length} Reports
          </span>
        </div>

        {qualityAddedMonths.length === 0 ? (
          <div className="text-center py-12 border-2 border-dashed border-gray-200 rounded-xl bg-gray-50/50">
             {/* Note: Printer is already imported, Calendar needed if used */}
          ...
          <div className="grid gap-3">
            {qualityAddedMonths.map((month, index) => (
              <div
                key={index}
                className="group relative bg-white p-4 rounded-xl border border-gray-200 shadow-sm hover:shadow-md hover:border-teal-200 transition-all cursor-pointer"
                onClick={() => handleQualityMonthDoubleClick(month)}
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 bg-gradient-to-br from-teal-500 to-emerald-600 text-white rounded-lg flex flex-col items-center justify-center shadow-sm">
                  ...
                  <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                    ...
                    <Button
                      ...
                      onClick={(e) => {
                        e.stopPropagation();
                        handleQualityMonthDoubleClick(month);
                      }}
